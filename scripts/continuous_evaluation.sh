...
num_beams=16
output_dir=continuous_model_digit_range_${digit_range_1}_${digit_range_2}_Seq_Length_${seq_length}_Layer_${num_layers}_Head_${num_heads}_Dist_Strategy_${dist_strategy}_Num_Beams_${num_beams}/
